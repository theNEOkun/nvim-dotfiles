...
M.Statusline = setmetatable(M, {
    __call = function(self, mode)
        return self["set_" .. mode](self)
    end,
})

local group = require('utils').autogroup('statusline');

require('utils').autocmd({ 'WinEnter', 'BufEnter' }, '*',
    ':lua vim.o.statusline = require"statline".Statusline("active")', group);
require('utils').autocmd({ 'WinLeave', 'BufLeave' }, '*',
    ':lua vim.o.statusline = require"statline".Statusline("inactive")',
    group);
